...
os.system("cmsearch --cpu 4 --mid -T 20 -incT 20 --tblout tblout.df.txt rrna.cm ribo-out/ribo-out.ribodbmaker.final.fa > cmscanOUTPUT.df.txt")
os.system("cmsearch --cpu 4 --mid -T 20 -incT 20 --anytrunc --tblout tblout.at.txt rrna.cm ribo-out/ribo-out.ribodbmaker.final.fa > cmscanOUTPUT.at.txt")
...
os.system("perl tblout-add.pl -t final.tblout 18 my.seqlen 1 > cmscan_final.tblout")

...
print('cmscan1')
os.system("cmsearch --cpu 4 --mid -T 20 --tblout tblout.df.txt rrna.cm ribo-out/ribo-out.ribodbmaker.final.fa > cmscanOUTPUT.df.txt &")
print('cmscan2')
os.system("cmsearch --cpu 4 --mid -T 20 --anytrunc --tblout tblout.at.txt rrna.cm ribo-out/ribo-out.ribodbmaker.final.fa > cmscanOUTPUT.at.txt")
...
CMscan_df = pd.read_csv(CMscan_output,
                        ...
                        header=None,
                        names=["accession", "gene","model", "mdl_from",
                               "mdl_to", "seq_from", "seq_to", "strand",
                               "trunc", "pass", "gc", "bias", "score",
                               "E-value", "Inc", "Length"])
CMscan_df = CMscan_df[0:]
